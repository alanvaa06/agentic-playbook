...
The PRD skill asks you discovery questions and produces a structured `context/tasks/prd-*.md` file that defines:
...
**Output:** `context/tasks/prd-[project-name].md`
...
**Output:** `context/tasks/agent-design-[agent-name].md`
...
- [ ] A completed PRD in `context/tasks/`

- [ ] A PEAS document in `context/tasks/` for each AI agent (if applicable)
