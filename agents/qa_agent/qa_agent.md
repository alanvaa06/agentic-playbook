...
|------------------------------------------------------|-------------------------------------------------------|
| `pytest` in `requirements.txt`                       | `agents/qa_agent/skills/testing_pytest.md`               |
| `jest` or `vitest` in `package.json`                 | `agents/qa_agent/skills/testing_jest.md`                  |
| `mypy` in `requirements.txt` or `pyproject.toml`     | `agents/qa_agent/skills/static_analysis_mypy.md`          |
| `ruff` in `requirements.txt` or `pyproject.toml`     | `agents/qa_agent/skills/linting_ruff.md`                  |
...
3. **Verify** — Cross-check your findings against loaded skill files and `Context/tasks/self-correction.md`.
...
- Cross-reference failures against `Context/tasks/self-correction.md`. Do NOT report a known, documented issue as a new failure — reference the existing entry instead.
...
2. **Consult** — Re-read the relevant skill file or `Context/tasks/self-correction.md` entry.
...
|------------|-------------|
| `agents/qa_agent/skills/testing_pytest.md` | Fixture design, async test client, factory patterns, DB isolation strategies |
| `agents/qa_agent/skills/testing_jest.md` | Supertest setup, mock patterns, DB teardown, coverage configuration |
| `agents/qa_agent/skills/static_analysis_mypy.md` | Type checking config, strict mode, plugin usage, common error patterns |
| `agents/qa_agent/skills/linting_ruff.md` | Rule selection, per-file ignores, formatter integration, pre-commit setup |
