...
|-----------------------------------------------------------------|-----------------------------------------------------------|
| `.git/` present (always)                                        | `agents/security_agent/skills/secrets_scanning.md`           |
| `requirements.txt` or `package.json` in scope                   | `agents/security_agent/skills/dependency_audit.md`           |
| `.py`, `.ts`, or `.js` source files in scope                    | `agents/security_agent/skills/sast.md`                       |
...
|------------|-------------|
| `agents/security_agent/skills/secrets_scanning.md` | git history scanning with gitleaks/truffleHog, detect-secrets pre-commit hooks, .gitignore completeness audit |
| `agents/security_agent/skills/dependency_audit.md` | pip-audit, npm audit, trivy image scanning, CVSS triage, pinning strategy |
| `agents/security_agent/skills/sast.md` | bandit (Python), semgrep (OWASP Top 10), eslint-plugin-security (Node/JS), suppression format |
