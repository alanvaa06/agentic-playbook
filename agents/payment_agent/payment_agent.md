...
|---------------------------------------------------------|---------------------------------------------------|
| `stripe` in `requirements.txt` or `package.json`        | `agents/payment_agent/skills/stripe.md`             |
| `paypalrestsdk` or `paypal-server-sdk`                  | `agents/payment_agent/skills/paypal.md`             |
| `mercadopago` in `requirements.txt` or `package.json`   | `agents/payment_agent/skills/mercadopago.md`        |
...
|------------|-------------|
| `agents/payment_agent/skills/stripe.md` | PaymentIntent lifecycle, idempotency keys, webhook signature verification, 3DS handling, refunds |
| `agents/payment_agent/skills/paypal.md` | Order lifecycle (CREATED → APPROVED → COMPLETED), IPN webhook verification, capture, refunds |
| `agents/payment_agent/skills/mercadopago.md` | Preference creation, IPN webhook `x-signature` verification, payment status confirmation, refunds |
