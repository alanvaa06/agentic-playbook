...
| `supabase` in `requirements.txt` or `package.json`   | `agents/backend_agent/skills/supabase_rls.md`            |
| `psycopg2`, `asyncpg`, or `pg` in any manifest       | `agents/backend_agent/skills/sql_postgres.md`            |
...
|------------|-------------|
| `agents/backend_agent/skills/fastapi_architecture.md` | Router structure, dependency injection, lifespan events, Pydantic v2 patterns, background tasks |
| `agents/backend_agent/skills/supabase_rls.md` | Row Level Security policies, supabase-py client, auth helpers, realtime subscriptions |
| `agents/backend_agent/skills/sql_postgres.md` | Raw SQL safety, async drivers (asyncpg/psycopg), indexing rules, migration conventions |
