...
|------------|------------|
| `agents/agentic_ai_architect/skills/frameworks/[framework]/SKILL.md` | [Framework-specific agent patterns] |
| `agents/agentic_ai_architect/skills/retrieval/[retrieval]/SKILL.md` | [If retrieval is an actuator — RAG patterns] |
| `agents/agentic_ai_architect/skills/data/[data]/SKILL.md` | [If multimodal input is a sensor] |

---

## Handoff

→ Pass this document to `agents/agentic_ai_architect/agentic_ai_architect.md` to begin architecture and implementation.
````
