...
- When external retrieval (RAG/CRAG) already provides trusted context — use `agents/agentic_ai_architect/skills/retrieval/crag/SKILL.md` instead
- Simple code generation tasks (use `agents/shared/skills/prompt_engineering/self-refine/SKILL.md` instead)
