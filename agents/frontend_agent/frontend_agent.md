...
|-------------------------------|---------------------------------------------------------|
| `react` in package.json      | `agents/frontend_agent/skills/react_best_practices.md`     |
| `tailwindcss` in package.json | `agents/frontend_agent/skills/tailwind_design_system.md`  |
| `framer-motion` in package.json | `agents/frontend_agent/skills/framer_motion.md`         |
| `@react-three/fiber` in package.json | `agents/frontend_agent/skills/react_three_fiber.md` |
| `react-hook-form` + `zod` in package.json | `agents/frontend_agent/skills/forms_validation.md` |
| `@sanity/client` in package.json | `agents/frontend_agent/skills/sanity_cms.md`           |
| `lenis` in package.json         | `agents/frontend_agent/skills/smooth-scroll.md`        |
| `gsap` in package.json          | `agents/frontend_agent/skills/gsap-animations.md`      |
...
|------------|-------------|
| `agents/frontend_agent/skills/react_best_practices.md` | Functional components, hooks discipline, TypeScript patterns, component file structure |
| `agents/frontend_agent/skills/tailwind_design_system.md` | oklch color vars, CVA variants, `cn()` utility, dark-mode-first conventions |
| `agents/frontend_agent/skills/framer_motion.md` | Animation variants, `AnimatePresence`, performance rules, scroll reveal patterns |
| `agents/frontend_agent/skills/react_three_fiber.md` | Suspense boundaries, `useFrame` performance, dispose on unmount, Drei helpers |
| `agents/frontend_agent/skills/forms_validation.md` | React Hook Form + Zod integration, schema file organization, async submit handling |
| `agents/frontend_agent/skills/sanity_cms.md` | GROQ queries, `sanityClient` singleton, image URL builder, typed response schemas |
| `agents/frontend_agent/skills/smooth-scroll.md` | Lenis initialization, `data-lenis-prevent`, programmatic scroll, ticker integration |
| `agents/frontend_agent/skills/gsap-animations.md` | Scroll-locked sections, odometer counters, ScrollTrigger, `gsap.context()` cleanup |
