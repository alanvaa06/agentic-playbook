...
|------------------------------------------------------|-------------------------------------------------------------------|
| `langchain` or `langgraph` in `requirements.txt`     | `agents/agentic_ai_architect/skills/frameworks/langchain/SKILL.md`               |
| `langchain` or `langgraph` in `requirements.txt`     | `agents/agentic_ai_architect/skills/frameworks/langchain/reference.md`           |
| `llama-index` in `requirements.txt`                  | `agents/agentic_ai_architect/skills/retrieval/llamaindex/SKILL.md`               |
| `crewai` in `requirements.txt`                       | `agents/agentic_ai_architect/skills/frameworks/crewai/SKILL.md`                  |
| `autogen` or `pyautogen` in `requirements.txt`       | `agents/agentic_ai_architect/skills/frameworks/autogen/SKILL.md`                 |
| `smolagents` in `requirements.txt`                   | `agents/agentic_ai_architect/skills/frameworks/smolagents/SKILL.md`              |
| `openai` in `requirements.txt` or `package.json`     | `agents/agentic_ai_architect/skills/frameworks/openai/SKILL.md`                  |
| `anthropic` in `requirements.txt` or `package.json`  | `agents/agentic_ai_architect/skills/frameworks/anthropic/SKILL.md`               |
| Unreliable retrieval or web fallback needed           | `agents/agentic_ai_architect/skills/retrieval/crag/SKILL.md`                     |
| Financial document analysis                          | `agents/agentic_ai_architect/skills/retrieval/financial-rag/SKILL.md`            |
| PDF, image, or chart inputs                          | `agents/agentic_ai_architect/skills/data/multimodal-parsing/SKILL.md`            |
| Vision API calls (image understanding)               | `agents/agentic_ai_architect/skills/data/vision-api-syntax/SKILL.md`             |
| Training data or evaluation set generation           | `agents/agentic_ai_architect/skills/data/synthetic-data/SKILL.md`                |
| `pinecone-client` in `requirements.txt`              | `agents/agentic_ai_architect/skills/vector_dbs.md`                         |
| `pgvector` in `requirements.txt`                     | `agents/agentic_ai_architect/skills/vector_dbs.md`                         |
...
| Single document, unreliable retrieval | **Corrective RAG (CRAG)** | `agents/agentic_ai_architect/skills/retrieval/crag/SKILL.md` |
| Multiple documents, comparison queries | **Agentic RAG (ReAct)** | `agents/agentic_ai_architect/skills/frameworks/langchain/SKILL.md` or `agents/agentic_ai_architect/skills/retrieval/llamaindex/SKILL.md` |
| Multiple documents + web fallback | **CRAG + ReAct hybrid** | `agents/agentic_ai_architect/skills/retrieval/crag/SKILL.md` |
| Complex multi-step reasoning with state | **LangGraph StateGraph** | `agents/agentic_ai_architect/skills/frameworks/langchain/reference.md` |
...
| Scenario | Recommended Pattern | Skill Reference |
|----------|---------------------|-----------------|
| Role-based delegation with a manager | **CrewAI Crew** | `agents/agentic_ai_architect/skills/frameworks/crewai/SKILL.md` |
| Conversational agents with debate/consensus | **AutoGen Group Chat** | `agents/agentic_ai_architect/skills/frameworks/autogen/SKILL.md` |
| Lightweight tool-calling agents | **SmolAgents** | `agents/agentic_ai_architect/skills/frameworks/smolagents/SKILL.md` |
| Complex state machine with conditional routing | **LangGraph StateGraph** | `agents/agentic_ai_architect/skills/frameworks/langchain/reference.md` |
...
| Scenario | Recommended Pattern | Skill Reference |
|----------|---------------------|-----------------|
| Chart-heavy PDFs requiring visual understanding | **Claude Vision pipeline** | `agents/agentic_ai_architect/skills/frameworks/anthropic/SKILL.md` + `agents/agentic_ai_architect/skills/data/multimodal-parsing/SKILL.md` |
| General image understanding | **Vision API chain** | `agents/agentic_ai_architect/skills/data/vision-api-syntax/SKILL.md` |
| Long text-heavy documents (>100 pages) | **Gemini long-context** | `agents/agentic_ai_architect/skills/frameworks/openai/SKILL.md` (or Gemini equivalent) |
| Mixed text + tables + images | **Multimodal parsing pipeline** | `agents/agentic_ai_architect/skills/data/multimodal-parsing/SKILL.md` |
...
| Scenario | Recommended Pattern | Skill Reference |
|----------|---------------------|-----------------|
| SEC filing Q&A with source citation | **Financial RAG** | `agents/agentic_ai_architect/skills/retrieval/financial-rag/SKILL.md` |
| Multi-ticker comparison | **Financial RAG + Agentic ReAct** | `agents/agentic_ai_architect/skills/retrieval/financial-rag/SKILL.md` + `agents/agentic_ai_architect/skills/frameworks/langchain/SKILL.md` |
| Structured metric extraction from tables | **Financial RAG + Multimodal** | `agents/agentic_ai_architect/skills/retrieval/financial-rag/SKILL.md` + `agents/agentic_ai_architect/skills/data/multimodal-parsing/SKILL.md` |
...
| Scenario | Recommended Pattern | Skill Reference |
|----------|---------------------|-----------------|
| Evaluation dataset for RAG | **Synthetic Q&A generation** | `agents/agentic_ai_architect/skills/data/synthetic-data/SKILL.md` |
| Fine-tuning dataset with domain knowledge | **Seeded generation pipeline** | `agents/agentic_ai_architect/skills/data/synthetic-data/SKILL.md` |
| Adversarial test cases | **Red-team data generation** | `agents/agentic_ai_architect/skills/data/synthetic-data/SKILL.md` |
...
|------------|-------------|
| `agents/agentic_ai_architect/skills/frameworks/langchain/SKILL.md` | LangGraph ReAct agents, tool binding, state management, MemorySaver |
| `agents/agentic_ai_architect/skills/frameworks/langchain/reference.md` | LangGraph StateGraph patterns for complex multi-step reasoning |
| `agents/agentic_ai_architect/skills/frameworks/crewai/SKILL.md` | Role-based multi-agent crews with task delegation |
| `agents/agentic_ai_architect/skills/frameworks/autogen/SKILL.md` | Conversational multi-agent systems with group chat |
| `agents/agentic_ai_architect/skills/frameworks/smolagents/SKILL.md` | Lightweight tool-calling agents |
| `agents/agentic_ai_architect/skills/frameworks/openai/SKILL.md` | OpenAI Assistants API, function calling, vision |
| `agents/agentic_ai_architect/skills/frameworks/anthropic/SKILL.md` | Claude tool use, vision, long-context processing |
| `agents/agentic_ai_architect/skills/retrieval/llamaindex/SKILL.md` | LlamaIndex query engines, tool agents, Context chat engine |
| `agents/agentic_ai_architect/skills/retrieval/crag/SKILL.md` | Corrective RAG: relevance evaluation, query rewriting, web search fallback |
| `agents/agentic_ai_architect/skills/retrieval/financial-rag/SKILL.md` | Domain-specific financial document RAG with SEC filing patterns |
| `agents/agentic_ai_architect/skills/data/multimodal-parsing/SKILL.md` | PDF parsing, chart extraction, mixed-format document processing |
| `agents/agentic_ai_architect/skills/data/vision-api-syntax/SKILL.md` | Vision API patterns for image understanding |
| `agents/agentic_ai_architect/skills/data/synthetic-data/SKILL.md` | Synthetic dataset generation for fine-tuning and evaluation |
