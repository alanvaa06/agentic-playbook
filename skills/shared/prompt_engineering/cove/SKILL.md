...
- When external retrieval (RAG/CRAG) already provides trusted context â€” use `skills/agentic_ai_architect/retrieval/crag/SKILL.md` instead

- Simple code generation tasks (use `skills/shared/prompt_engineering/self-refine/SKILL.md` instead)
