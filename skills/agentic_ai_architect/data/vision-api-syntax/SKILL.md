...
- When the input is a PDF document (use `skills/agentic_ai_architect/data/multimodal-parsing/SKILL.md` instead)
...
# Reasoning call (o1) â€” same message structure, no json_mode
...
- Model returning 404 (check for sunset â€” verify current model names before replacing)
