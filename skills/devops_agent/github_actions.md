...
If you encounter a failing workflow step, a leaked secret in logs, a missed cache hit, or any pattern that required more than one attempt to get right, you MUST log the failure to `context/tasks/self-correction.md` before marking the task complete.
